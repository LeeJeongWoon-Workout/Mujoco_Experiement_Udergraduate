...
# when tau=0 this is vanilla stochastic replay buffer
class vanilla_episodic_buffer:
    def __init__(self, capacity,seed,tau=0):
    ...
    def sample(self, batch_size):
        ...
        if len(self.hbuffer)<batch_size:
            ...
            if r>self.tau:
                ...
                batch=random.sample(self.hbuffer,batch_size)
